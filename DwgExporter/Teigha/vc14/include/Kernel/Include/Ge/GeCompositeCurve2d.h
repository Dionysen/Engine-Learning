...
public:
  ...
  */
  ...
  /** \details 
    Copy constructor for the OdGeCompositeCurve2d class.
  ...
  */
  ...
  /** \details 
    Constructor for the OdGeCompositeCurve2d class. Creates a composite curve from the array of pointers to curves.
