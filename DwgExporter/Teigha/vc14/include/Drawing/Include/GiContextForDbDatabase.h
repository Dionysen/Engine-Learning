...
/** \details
    ...
    vectorization of an OdDbDatabase.
...
private:
  enum
  {
    ...
    kUseTtfTriangleCache             = 2048,
    kLastFlag                        = kUseTtfTriangleCache
  };
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param bPolyDraw [in]  Controls kUseTtfTriangleCache flag of this Context Object.
  */
  ...
  */
  virtual bool forceSortents() const { return false;}
};
