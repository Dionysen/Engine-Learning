...
protected:
  void addMoreObjectsToDeepClone(OdDbIdMapping& idMap,
    OdDbObjectIdArray& additionalObjectsToClone) const;
};


/** \details
  This class implements a collinear constraint node in the owning constraint group.
  This constraint can be applied between two lines.
...
public:
  ...
  */
  ...
  OdConstraintGroupNodeId getDatumLineId() const;
