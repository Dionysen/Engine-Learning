...
#ifndef _BMCATEGORYCDAPROPS_H_
#define _BMCATEGORYCDAPROPS_H_

/** \details
  Category node Elements RxCollectionProperty.
  Collects Level's elements of the specified category.
*/
struct OdBmCategoryNodeElementsProperty : OdRxCollectionProperty
{
  /** \details
    Creates an iterator for a collection.

    \param pO [in] An OdBmDynamicObject object representing "Category" in hierarchy tree.
  ...
  */
  ...
  /** \details
    ...
    \param pO [in] An OdBmDynamicObject object representing "Category" in hierarchy tree.
    \param count [out] Output number of element ids in a category.
...
/** \details
  Category name RxProperty.
*/
struct OdBmCategoryNodeNameProperty : OdRxProperty
{
  ...
  */
  ...
  /** \details
   ...
   \param pO [in] An OdBmDynamicObject object representing "Category" in hierarchy tree.
   \param value [out] OdRxValue of OdString type, containing category name.
