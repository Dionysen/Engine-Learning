...
public:
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link tv_working_with_attributes_visual_styles.html, Working with Visual Styles>
  */
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link tv_working_with_base_classes_view.html, Working with Visualize Graphical Views>
  */
  ...
  */
  ...
  //begin/endVectorization() needs an argument indicating a mode
  //But introducing such argument causes changes in all derived classes.
