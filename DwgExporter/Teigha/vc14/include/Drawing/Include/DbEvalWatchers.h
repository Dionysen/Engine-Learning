...
/** \details
    ...
    \remarks
    This protocol extension is added to the OdDbLeader class by the Drawings while initializing.
...
/** \details
    ...
    \remarks
    This protocol extension is added to the OdDbFcf class by the Drawings while initializing.
