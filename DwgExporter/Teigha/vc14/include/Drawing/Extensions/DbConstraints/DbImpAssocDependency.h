...
public: 
  ...
  */
  OdResult setStatus(OdDbAssocDependency *pDep, OdDbAssocStatus newStatus, bool notifyOwningAction);//
  ...
  */
  OdResult getDependentOnCompoundObject(OdDbCompoundObjectId&) const;

  /** \details
    Deprecated.
  */
  OdResult getDependentOnCompoundObject(OdDbCompoundObjectIdPtr& pid) const {
    pid = OdDbCompoundObjectId::createObject();
    return getDependentOnCompoundObject(*pid);
  };
  ...
  */
  OdResult attachToObject(const OdDbCompoundObjectId &compoundId, OdDbAssocDependency *pDep);

  /** \details
    Deprecated.
  */
  OdResult attachToObject(const OdDbCompoundObjectId *pCompoundId, OdDbAssocDependency *pDep) {
    return attachToObject(*pCompoundId, pDep);
  }
  ...
  */
  void setDependentOnObject(const OdDbCompoundObjectId& compoundId, OdDbAssocDependency *pDep);

  /** \details
    Sets the dependent-on object for this dependency using the given compound object.
  */
  void setDependentOnObject(const OdDbCompoundObjectId* pCompoundId, OdDbAssocDependency *pDep) {
    return setDependentOnObject(*pCompoundId, pDep);
  }
  ...
  */
  virtual bool hasCachedValue() const;
  ...
  */
  ...
  /** \details
    Notification callback for OdDbObject::erased(). This method is called when the 'dependentOnObject' is erased.
  */
  virtual void erased(const OdDbObject* depOnObj, OdDbAssocDependency *dep, bool isErasing = true);

  /** \details
    Notification callback for OdDbObject::modified(). This method is called when the 'dependentOnObject' is modified.
  */
  virtual void modified(const OdDbObject* depOnObj, OdDbAssocDependency *dep);

  /** \details
    Notification callback for OdDbObject::copied(). This method is called when the 'dependentOnObject' is copied.
  */
  virtual void copied(const OdDbObject* depOnObj, const OdDbObject* copy, OdDbAssocDependency *dep);
  ...
  */
  ...
  /** Description:
    Relinks dependency list attached onto a giving object as persistent reactors wich may be broken after clon operations
  */
  static void relinkDependenciesOn(OdDbObject* pObj);
  ...
  /*!DOM*/
  OdResult checkGetBody(OdDbAssocDependencyBodyPtr& outBody, OdDb::OpenMode mode = OdDb::kForRead) const;
protected:
  /*!DOM*/
  bool isThisDependencyOn(const OdDbObject* object);
  /*!DOM*/
  void writeStatus(OdDbAssocDependency* pDbObject, OdDbAssocStatus newStatus);
  /*!DOM*/
  ...
  /*!DOM*/
  OdDbCompoundObjectId m_refPath;
