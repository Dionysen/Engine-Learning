...
public:
  ...
  /** \details 
    Default constructor for the OdGeEllipArc3d class. Constructs an elliptical arc in the XY plane (normal vector (0.0, 0.0, 1.0)) with center (0.0, 0.0, 0.0), major and minor radii set to 1.0,
    major axis set to (1.0, 0.0, 0.0) and minor axis set to (0.0, 1.0, 0.0).
  */
  OdGeEllipArc3d();
  
  /** \details 
    Copy constructor for the OdGeEllipArc3d class.
  ...
  */
  ...
  /** \details
    ...
    and returns the number of intersections and points of the intersection.
  ...
  */
  ...
  /** \details
    ...
    \param rad [in]  The minor radius of the elliptical arc.
  */
  ...
  /** \details
    ...
    \param rad [in]  The major radius of the elliptical arc.
  */
  ...
  */
  ...
  /** \details
     ...
     co-directional normals and the corresponding radii equal.
     The starting point of the join curve should coincide with the end point of this curve.
     If these conditions are not met, this method raises the eInvalidInput error.
     \remarks
     If the ellipses are circles (isCircular(tol)),
     then the angle between the corresponding axes can be arbitrary.
     In the general case, only the n * OdaPI angle is allowed.
