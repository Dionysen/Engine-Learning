...
public:
  ...
  */
  ...
  /**
    ...
    \remarks
    The normal vector must be perpendicular to refVec, and endAngle must be greater than startAngle. 
    All angles are expressed in radians.
    \remarks
    To construct a full circle, specify the endAngle and startAngle, so the difference between them is 2 x Pi. 
    In common case parameter(paramOf,evalPoint,evaluate) interval is NOT equal to [startAng; endAng]! But it length is endAng - startAng.
  */
  OdGeCircArc3d(
    const OdGePoint3d& center,
    const OdGeVector3d& normal,
  ...
  */
   ...
   /** \details
      ...
      \remarks
      Curves should not overlap. The circles should have the same center,
      radius and co-directional normals. the starting point of the join
      curve should coincide with the end point of this curve.
