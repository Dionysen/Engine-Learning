...
<group OdDb_Classes>
*/
class TOOLKIT_EXPORT OdDbGeoDataProvidersStringPE : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdDbGeoDataProvidersStringPE);

  /** \details
    Virtual destructor.
  */
  virtual ~OdDbGeoDataProvidersStringPE() {};
  /** \details
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdDbGeoDataProvidersStringPE object pointers.
*/
typedef OdSmartPtr<OdDbGeoDataProvidersStringPE> OdDbGeoDataProvidersStringPEPtr;
