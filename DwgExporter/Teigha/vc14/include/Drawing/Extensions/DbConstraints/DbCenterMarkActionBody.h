...
public:
  ...
  */
  ...
  OdResult getAllExtensionPoints(OdGePoint3dArray& ) ;
  OdResult getAllExtensionPoints(OdGePoint3d &, OdGePoint3d &, OdGePoint3d &, OdGePoint3d &);
  OdResult getAllOvershootPoints(OdGePoint3dArray& ) ;
  OdResult getAllOvershootPoints(OdGePoint3d &, OdGePoint3d &, OdGePoint3d &, OdGePoint3d &);
  OdResult getCenterPoint(OdGePoint3d &);
  ...
  OdResult setCenterPoint(OdGePoint3d const &);
