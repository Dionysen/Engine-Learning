...
public:
  ...
  */
  ...
  /** \details
    Assignment operator for the OdGiFaceStyle class. Returns reference to OdGiFaceStyle with new assigned style properties.

    \param style [in]  Face style properties to assign.
  */
  OdGiFaceStyle& operator=(const OdGiFaceStyle& style);
  
  /** \details
    Equality operator for the OdGiFaceStyle class.
    Style properties are considered equal if:
    * Lighting models are equal;
    * Lighting quality values are equal;
    * Face color modes are equal;
    * Opacity levels are equal;
    * Specular amounts are equal;
    * Colors that are used in the monocolor mode are equal;
    * Face modifier flags are equal.
    
    \param style [in]  Face style to compare.
    \returns
    true if face styles are equal, false otherwise.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns
    true if the passed face modifier is set, false otherwise.
  */
...
public:
  ...
  */
  ...
  /** \details
    Assignment operator for the OdGiEdgeStyle class. Returns reference to OdGiEdgeStyle object with assigned parameters.

    \param style [in]  Edge style to assign.
  */
  OdGiEdgeStyle& operator=(const OdGiEdgeStyle& style);
  
  /** \details
    Equality operator for the OdGiEdgeStyle class.
    Style properties are considered equal if:
    * Edge models equal;
    * Edge style flags are equal;
    * Intersection colors are equal;
    * Colors for obscured edges are equal;
    * Linetypes for obscured edges are equal;
    * Crease angles are equal;
    * Edge colors are equal;
    * Opacity levels are equal;
    * Edge width values are equal;
    * Overhang amount values are equal;
    * Jitter values are equal;
    * Wiggle amount values are equal;
    * Silhouette colors are equal;
    * Silhouette width values are equal;
    * Halo gaps are equal;
    * Isolines are equal;
    * Hide precision values are equal;
    * Types of geometry to which edge styles are applied must be the same;
    * Intersection linetypes are equal;
    * Edge modifier flags are equal;
    
    \param style [in]  Edge style to compare.
    \returns
    true if edge styles are equal, false otherwise.
  */
  ...
  */
  ...
  /** \details
    ...
    \param flag [in]  Flag to be checked whether it's enabled or disabled.
    \returns
    true if the passed edge modifier is set, false otherwise.
  */
  ...
  */
  ...
  /** \details
    Checks whether hide precision is enabled.
    \returns 
    true if hide precision is enabled, false otherwise.
  */
...
public:
  ...
  */
  ...
  /** \details
    Assignment operator for the OdGiDisplayStyle class. Returns reference to OdGiDisplayStyle with new assigned style properties.

    \param style [in]  Display style properties to assign.
  */
  OdGiDisplayStyle& operator=(const OdGiDisplayStyle& style);
  
  /** \details
    Equality operator for the OdGiDisplayStyle class.
    Style properties are considered equal if:
    * Display settings are equal;
    * Brightness values are equal;
    * Shadow types are equal;
    
    \param style [in]  Display style to compare.
    \returns
    true if display styles are equal, false otherwise.
  */
  ...
  */
  ...
  /** \details
    ...
    \param flag [in]  Flag to be checked whether it's enabled or disabled.
    \returns
    true if the passed display setting flag is set, false otherwise.
  */
...
namespace OdGiVisualStyleProperties
{
  ...
  */
  enum FaceColorMode    
  {
    ...
    kBackgroundTexture    = 6   // Apply actual background texture to the faces.
  };
...
*/
  ...
  /** \details
    Assignment operator for the OdGiVisualStyle class. Returns reference to OdGiVisualStyle with new assigned style properties.

    \param visualStyle [in]  Visual style to assign.
  */
  OdGiVisualStyle& operator=(const OdGiVisualStyle& visualStyle);
  
  /** \details
    Equality operator for the OdGiVisualStyle class.
    Style properties are considered equal if all the values for properties of visual styles (from the OdGiVisualStyleProperties::Property enumeration) are equal:
    
    \param visualStyle [in]  Visual style to compare.
    \returns
    true if visual styles are equal, false otherwise.
  */
  ...
  */
  ...
  /** \details
    The data type that represents a visual style property. 
  */
  typedef OdGiVisualStyleProperties::Property Property;
  /** \details
    The data type that represents a visual style operation. 
  */
