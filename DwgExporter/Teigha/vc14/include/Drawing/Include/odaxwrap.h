...
#if defined(_MSC_VER) && (_MSC_VER > 1310) && defined(_TOOLKIT_IN_DLL_) && !defined(_WIN32_WCE) && !defined(_WINRT)
...
#if defined(_MSC_VER) && defined(_TOOLKIT_IN_DLL_) && (_MSC_VER > 1310) && !defined(_WIN32_WCE) && !defined(_WINRT)
