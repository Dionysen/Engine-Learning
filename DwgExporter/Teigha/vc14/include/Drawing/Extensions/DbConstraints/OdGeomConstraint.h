...
public:
  ...
  */
  enum GeomConstraintType
  {
    ...
    kColinear         ,    // Collinear constraint applied between two lines.
  ...
  */
  ...
  /** \details
    Leaves the geometry constraint node in the constraint group and removes it from the DCM dimension system. 
  */
  OdResult deactivate();
...
protected:
  friend class AddMoreObjectsFromConnectedConstraints;

  /*!DOM*/
  virtual void addMoreObjectsToDeepClone(OdDbIdMapping& idMap,
