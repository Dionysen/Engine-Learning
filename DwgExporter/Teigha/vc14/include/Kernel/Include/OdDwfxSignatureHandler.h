...
/** \details
  A data type that represents a smart pointer to an <link OdDwfxSignatureHandler, OdDwfxSignatureHandler> object.
*/
...
/** \details
  A data type that represents a smart pointer to an <link OdDwfxSignatureHandlerModule, OdDwfxSignatureHandlerModule> object.
*/
