...
class OdTrVisRenderClient
{
  ...
  public:
    ...
    virtual OdTrVisRenderAbort *queryRenderAbort(const OdTrVisDirectRenderPartialUpdateInvocation * /*pInvocation*/,
                                                 bool /*bAutoStart*/ = false) { return NULL; }
};
