...
namespace Dionysen
{
    ...
    void OpenGLFramebuffer::Invalidate()
    {
        ...
        if (m_ColorAttachmentSpecifications.size())
        {
            ...
            for (size_t i = 0; i < m_ColorAttachments.size(); i++)
            {
                ...
                case FramebufferTextureFormat::RGBA8:
                    ...
                    break;
                case FramebufferTextureFormat::RED_INTEGER:
                    Utils::AttachColorTexture(m_ColorAttachments[i], m_Specification.Samples, GL_R32I, GL_RED_INTEGER, m_Specification.Width,
                                              m_Specification.Height, i);
                    break;
                }
            }
        ...
        {
            DION_CORE_ASSERT(m_ColorAttachments.size() <= 4);
        ...
        DION_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
    ...
    void OpenGLFramebuffer::Resize(uint32_t width, uint32_t height)
    {
        ...
        {
            DION_CORE_WARN("Attempted to rezize framebuffer to {0}, {1}", width, height);
            return;
        }
