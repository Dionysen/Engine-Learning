...
/** \details
    ...
    \sa
    <link ge_OdGeNurbCurve2d, Working with NURBS curves>
*/
class GE_TOOLKIT_EXPORT OdGeNurbCurve2d : public OdGeSplineEnt2d
{
public:
  /** \details
    Default constructor for the OdGeNurbCurve2d class. Constructs an empty NURB curve.
  */
  OdGeNurbCurve2d();
  
  /** \details
    Copy constructor for the OdGeNurbCurve2d class.
  ...
  */
  ...
  /** \details
    ...
    If startTangentDefined is 0, then startTangent will be ignored and the constructor will 
    compute the start tangent vector. The same is true for endTangentDefined.
  */
  OdGeNurbCurve2d(
  ...
  */
  ...
  /** \details
    ...
    \remarks   
    Constructs a 2D polynomial curve interpolating a given array if 2D points within given tolerance. 
    If isPeriodic = true, then the first and the last fitPoints must be identical. The same must be true for fitTangents.  
  */
  OdGeNurbCurve2d(
    const OdGePoint2dArray& fitPoints,
  ...
  /** \details
    ...
    \remarks   
    Constructs a 2D curve from passed 2D elliptical arc.  
  */
  OdGeNurbCurve2d(
  ...
  /** \details
    ...
    \remarks   
    Constructs a 2D curve from passed 2D line segment.  
  */
  OdGeNurbCurve2d(
  ...
  /** \details
    ...
    \remarks   
    Constructs a 2D curve interpolating a given array of 2D points within given tolerance and knot parameterization, 
    and having given derivatives at the start point and endpoint. If startTangentDefined is 0, then startTangent is ignored 
    and the constructor computes the start tangent vector. Similarly for endTangentDefined.
  ...
  */
  ...
  /** \details
    ...
    \returns
    Returns true if and only if the this spline was created with fit data
...
protected:
  ...
  /** \details
    ...
    \param endTangent [in]  Ending tangent.
  */
  void setData(int degree, const OdGeKnotVector& knots,
