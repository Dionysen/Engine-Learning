...
#undef ODTRRND_SI_DEF_FLAG
  ...
  public:
    ...
    virtual OdTrVisStateBranchDef *getHlBranchDef(OdTrVisStateBranchId hlId) const = 0;
    virtual OdTrVisOwning getHlBranchOwner(OdTrVisStateBranchId hlId) const = 0;
    virtual OdTrVisStateBranchId getMetafileHlBranch(OdTrVisMetafileId mfId) const = 0;
    virtual OdTrVisStateBranchId getNestedHlBranch(OdTrVisStateBranchId hlId, OdTrVisOwning ownerId) const = 0;
