...
public:
  ...
  */
  ...
  OdGePoint3d m_coord;     //Source point coordinates
  ODCOLORREF  m_color;     //Source point color
  float       m_intensity; //Source point intensity
};
...
public:
  ...
  /** \details
    ...
    The m_isTerrestrial flag specified that input data is terrestrial if set to
  ...
  */
  ...
  float m_intensityBottom; //Lower intensity threshold
  float m_intensityUpper; //Upper intensity threshold
  bool  m_isTerrestrial; //A flag, indicating whether input data is terrestrial (true) or lidar (false)
};
...
public:
  ...
  */
  ...
  /** \details
    Gets the source point that is currently pointed at by the
    source point data iterator. The iterator object steps forward after getting
    the point.
...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns
    Shared pointer to a OdSourcePointIterator object.
  */
