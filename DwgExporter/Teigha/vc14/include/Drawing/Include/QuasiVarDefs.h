...
/**
  ...
  <table>
    <b>Type</b>            bool
    <b>Initial value</b>   Depends on the drawing
    <b>Read-Only</b>       Yes
    <b>Saved In</b>        Database
    <b>Versions</b>        2019+
  </table>
   
  The STUDENTDRAWING variable specifies whether the drawing was created using
  an educational version of the software.
   
  <table>
    <b>Value</b>   <b>Description</b>
    false          Drawing was created using non-educational version
    true           Drawing was created using educational version
  </table>
