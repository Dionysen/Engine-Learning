...
/** \details
    ...
    2D line segment can be defined with a start and end points
    or with a point and a non-zero vector that specifies segment length and direction.
...
public:
  ...
  /** \details
    Default constructor for the OdGeLineSeg2d class. Constructs a line segment between the points (0.0, 0.0) and (1.0, 0.0).
  */
  OdGeLineSeg2d();
  
  /** \details
    Copy constructor for the OdGeLineSeg2d class.
  ...
  */
  ...
  /** \details
    ...
    \param point1 [in]  First 2D point that represents a start of a segment.
    \param point2 [in]  Second 2D point that represents an end of a segment.
  */
  OdGeLineSeg2d(
  ...
  /** \details
    ...
    \param point [in]  A 2D point that represents a start of a segment.
  ...
  */
  ...
  /** \details
    ...
    \param point [in]  A 2D point that represents the start of a segment.
    \param vect [in]  Defines the direction of the line and the second point of the line.
  ...
  */
  ...
  /** \details
    ...
    \param point1 [in]  First 2D point that represents the start of a segment.
    \param point2 [in]  Second 2D point that represents an end of a segment.
