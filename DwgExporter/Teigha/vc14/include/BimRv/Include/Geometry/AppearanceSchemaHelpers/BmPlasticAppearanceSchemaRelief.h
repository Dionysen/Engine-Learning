...
#ifndef _BM_PLASTICVINYLAPPEARANCESCHEMA_RELIEF_H_
#define _BM_PLASTICVINYLAPPEARANCESCHEMA_RELIEF_H_
#include "Geometry/Entities/BmAsset.h"

/** \details
  A helper class to work with relief part of Plastic appearance schema.
*/
class TB_GEOMETRY_EXPORT OdBmPlasticAppearanceSchemaRelief
{
public:
  /** \details
    Default constructor.
  ...
  */
  OdBmPlasticAppearanceSchemaRelief(const OdBmAssetPtr& pAsset) :m_pAsset(pAsset) {}
  ...
  */
  ...
  /** \details
    Sets the bump amount: 0 to 2 to increase the depth of the surface irregularities, 0 to make the surface flat.
...
#endif // _BM_PLASTICVINYLAPPEARANCESCHEMA_RELIEF_H_
