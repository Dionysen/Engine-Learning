...
DBROOT_EXPORT bool odutWcMatch(const OdChar* string, const OdChar* wcPattern);
DBROOT_EXPORT bool odutWcMatchNoCase(const OdChar* string, const OdChar* wcPattern);
DBROOT_EXPORT bool odutWcMatch(const OdChar* string, const OdString& wcPattern, OdString* remainString);
DBROOT_EXPORT bool odutWcReplace(const OdString& string,
  const OdString& wcPatternOld,
  const OdString& wcPatternNew,
  OdString& resultString);
