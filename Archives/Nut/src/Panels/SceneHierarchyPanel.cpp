...
namespace Dionysen
{
    ...
    void SceneHierarchyPanel::DrawComponents(Entity entity)
    {
        ...
        DrawComponent<TextComponent>("Text Renderer", entity, [](auto& component) {
            ImGui::InputTextMultiline("Text String", component.TextString.data(), component.TextString.size(),
                                      ImVec2(0, ImGui::GetTextLineHeight() * 16), ImGuiInputTextFlags_AllowTabInput);
            ImGui::ColorEdit4("Color", glm::value_ptr(component.Color));
