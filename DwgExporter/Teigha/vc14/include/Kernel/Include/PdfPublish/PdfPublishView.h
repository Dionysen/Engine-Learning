...
public:
  ...
  */
  ...
  /** \details 
    Returns the current internal name of the view.
  ...
  */
  ...
  /** \details 
    Returns the current external name of the view.
    The method fills a passed string object and returns it to a calling subroutine.
  ...
  */
  ...
  /** \details 
    Returns the current view camera.
  ...
  */
  ...
  /** \details 
    Returns the current view background color.
  ...
  */
  ...
  /** \details 
    Returns the current view lighting mode.
  ...
  */
  ...
  /** \details 
    Returns the current view rendering mode.
