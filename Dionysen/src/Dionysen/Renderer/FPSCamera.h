...
namespace Dionysen
{
    ...
    class FPSCamera
    {
      public:
        ...
        // processes input received from any keyboard-like input system. Accepts input parameter in the form of camera defined ENUM (to abstract it
      ...
      private:
        ...
        void updateCameraVectors()
        {
            ...
            Right = glm::normalize(glm::cross(Front,
                                              WorldUp));  // normalize the vectors, because their length gets closer to 0 the more you look up or down
