...
public:
  ...
  */
  ...
  /** \details
    ...
    \param pView [in]  Pointer to the view where the specified entity should be highlighted.
  */
  virtual void highlight(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true, const  OdGsView* pView = 0) = 0;
  ...
  */
  virtual void hide(const OdGiPathNode& path, bool bDoIt = true, bool bSelectHidden = false, const  OdGsView* pView = 0) = 0;
