...
/** \details
    ...
    3D line segment can be defined with a start and end points
...
public:
  /** \details
    Default constructor for the OdGeLineSeg3d class. Constructs a line segment between the points (0.0, 0.0, 0.0) and (1.0, 0.0, 0.0).
  */
  OdGeLineSeg3d();
  ...
  */  
  ...
  /** \details
    ...
    \param point [in]  First point of a line segment.
  ...
  */
  ...
  /** \details
    ...
    \param point1 [in]  Start point of a line segment.
  ...
  */
  ...
  /** \details
    ...
    \param point [in]  Start point of a line segment.
    \param vect [in]  A 3D vector that defines the line direction and second point.
  ...
  */
  ...
  /** \details
    ...
    \param point1 [in]  First point of a line segment.
    \param point2 [in]  Second point of a line segment.
  ...
  */
  ...
  /** \details
    ...
    success [out] Link to the himself *curve*.
