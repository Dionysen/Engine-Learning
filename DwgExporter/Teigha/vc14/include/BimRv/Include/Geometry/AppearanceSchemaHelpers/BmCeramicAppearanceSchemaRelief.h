...
#ifndef _BM_CERAMICAPPEARANCESCHEMA_RELIEF_H_
#define _BM_CERAMICAPPEARANCESCHEMA_RELIEF_H_
...
*/
class TB_GEOMETRY_EXPORT OdBmCeramicAppearanceSchemaRelief
{
public:
  /** \details
    Default constructor.
  ...
  */
  OdBmCeramicAppearanceSchemaRelief(const OdBmAssetPtr& pAsset) :m_pAsset(pAsset) {}
...
#endif // _BM_CERAMICAPPEARANCESCHEMA_RELIEF_H_
