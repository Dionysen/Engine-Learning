...
namespace Dionysen
{
    class Renderer2D
    {
      public:
        ...
        static void DrawCircle(const glm::vec3& position, const glm::vec4& color, float thickness = 1.0f, float fade = 0.005f, int entityID = -1);

        static void DrawCircle(const glm::vec3& position, const float radius, const glm::vec4& color, float thickness = 1.0f, float fade = 0.005f,
                               int entityID = -1);
...
#endif  // ENGINE_LEARNING_RENDERER2D_H
