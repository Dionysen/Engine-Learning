...
public:
  ...
  */ 
  ...
  /** \details
    ...
    \param pXform [in]  Optional boundary transform matrix.
    \param bEnableSections [in]  Mark that the clipping stage can generate section geometry.
  */
  ...
  */ 
  virtual void pushClipStage(OdUInt32 nCounts, const int *counts,
                             ...
                             OdUInt32 numPlanes = 0, const ClipPlane *pPlanes = NULL, bool bEnableSections = false, PolyTolOverride *pPolyTol = NULL) = 0;
