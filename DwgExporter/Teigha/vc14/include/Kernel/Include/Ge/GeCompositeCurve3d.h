...
public:
  ...
  /** \details 
    Default constructor. Creates a composite curve that consists 
    of a single subcurve: a line segment from (0,0,0) to (1,0,0). 
  */
  OdGeCompositeCurve3d();

  /** \details 
    Copy constructor for the OdGeCompositeCurve3d class.
  ...
  */
  ...
  /** \details 
    ...
    \param curveList [out] An array of pointers to subcurves comprising the composite curve.
  */
  ...
  /** \details 
    ...
    \returns Constant reference to an array of pointers to subcurves comprising the composite curve.

    \remarks
    TD Special
  */
  const OdGeCurve3dPtrArray& getCurveList() const;
  ...
  */
  ...
  /** \details 
    ...
    \param subCurves [in] Array of the subcurves comprising the composite curve.
    \param number    [in] Number of subcurves.
  ...
  */
  ...
  /** \details 
    Assignment operator for the OdGeCompositeCurve3d class. Copies other curve data to this object.
