...
namespace Dionysen
{
        ...
        : m_Data(new MSDFData())
    {
        ...
        if (!font)
        {
            DION_CORE_ERROR("Failed to load font: {}", fileString);
            return;
        }
        ...
        DION_CORE_INFO("Loaded {} glyphs from font (out of {})", glyphsLoaded, charset.size());
...
#define THREAD_COUNT 8
        ...
        m_AtlasTexture = CreateAndCacheAtlas<uint8_t, float, 3, msdf_atlas::msdfGenerator>("Test", (float)emSize, m_Data->Glyphs,
