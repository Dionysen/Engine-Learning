...
#ifndef _ExBimCommandContext_h_Included_
#define _ExBimCommandContext_h_Included_

#include "TD_PackPush.h"

#include "Ed/EdFunctionIO.h"
#include "BmSSet.h"
#include "Database/BmCommandContext.h"
#include "StaticRxObject.h"
#include "Ed/EdBaseUserIO.h"
#include "BmUnitsFormatterImpl.h"
...
*/
class ExBimCommandContext : public OdBmCommandContext
                          , protected OdBmUserIO
                          , protected OdEdFunctionIO
{
protected:
  ODRX_USING_HEAP_OPERATORS(OdBmCommandContext);
...
public:
  ...
  */
  ...
  OdBmObjectId getDBViewportId(const OdBmDatabase* pDb);

  virtual OdBmSelectionSetPtr select(const OdString& sPrompt = OdString::kEmpty,
                                     int options = OdEd::kSelDefault,
                                     const OdBmSelectionSet* pDefVal = 0,
                                     const OdString& keywords = OdString::kEmpty,
                                     OdBmSSetTracker* pTracker = 0);

  protected:
    void merge( OdBmSelectionSet* pRes,
                int options,
                const OdBmSelectionSet* pSSet,
                OdBmSSetTracker* pTracker,
                OdEdUserIO* pIO);
...
#endif // _ExBimCommandContext_h_Included_
