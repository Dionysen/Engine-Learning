...
/** \details
    This class represents a raster image within the ODA vectorization framework.
...
public:
  OdRxObjectPtr clone() const
  {
    ...
    pRes->m_transparentColor = m_transparentColor;
  ...
  public:
    ...
    */
    ...
    /** \details
      ...
      \param nTransparentColor [in]  Transparent color index.
    */
    void setTransparentColor(int nTransparentColor)
    {
      m_transparentColor = nTransparentColor;
    }
