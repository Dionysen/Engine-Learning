...
public:
  ...
  /** \details 
  The default constructor for the OdGeCircArc2d class. Constructs a full circle with a center (0.0, 0.0), radius of 1.0, and reference axis (1.0, 0.0).
  */
  OdGeCircArc2d();
  ...
  */
  ...
  /**
    \details Constructor for the OdGeCircArc2d class.
    \param center      [in]  Center of circle.
  ...
  */
  ...
  /**
    ...
    \remarks
    If a line is drawn between startPoint and endPoint, the distance between this line
    and the midpoint of the constructed arc is equal to the bulge distance.
    If bulgeFlag is true, the bulge is interpreted as the maximum distance between the arc and the chord between the two input points. 
    If bulgeFlag is false, the bulge is interpreted as the tangent of 1/4 the included angle (tan(ang/4)), where ang is the angle of the arc segment between the two input points.
