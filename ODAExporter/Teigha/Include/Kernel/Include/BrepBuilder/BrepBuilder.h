...
#define kDefaultGeometryId ULONG_MAX
...
public:
  ...
  */
  ...
  BRepBuilderGeometryId addFace(const OdGeSurface* pSurf, EntityDirection faceDirection, const BRepBuilderGeometryId& shellId = kDefaultGeometryId);
