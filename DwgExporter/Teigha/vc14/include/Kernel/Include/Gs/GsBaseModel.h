  ...
  public:
    ...
    */
    ...
    /** \details
      ...
      true.
    */
    virtual bool onHighlight(OdGsModel *pModel, const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt, const OdGsView* pView) { return true; }
    ...
    */
    ...
    /** \details
      ...
      true.
    */
    virtual bool onHide(OdGsModel *pModel, OdGsNode *pNode, bool &bHidden, bool &bSelectable) { return true; }
    /** \details
      Callback that called before GsModel changes node hidden state.
      \param pModel [in]  Pointer to the model.
      ...
      \param bSelectable [in]  Flag that shows whether model is sectionable.
    */
    virtual bool onHide(OdGsModel *pModel, const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool& bHidden, bool &bSelectable) { return true; }
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_features_highlighting, Working with Highlighting>
  */
  void highlight(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true, const  OdGsView* pView = 0);
  //DOM-IGNORE-BEGIN
  virtual void highlightImpl(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true, const OdGsView* pView = NULL);
  //DOM-IGNORE-END
  /** \details
  ...
  */
  void hide(const OdGiPathNode& path, bool bDoIt = true, bool bSelectHidden = false, const  OdGsView* pView = 0);
  /** \details
    ...
    \param pView [in]  Pointer to the view where the specified entity should be hidden.
  */
  void hide(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true, bool bSelectHidden = false, const  OdGsView* pView = 0);
  /** \details
    Hides the specified subentities of entity in this Model object..
    ...
    \param pView [in]  Pointer to the view where the specified entity should be hidden.
  */
  virtual void hideImpl(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true, bool bSelectHidden = false, const  OdGsView* pView = 0);
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link tv_working_with_features_cutting_planes, Working with Cutting Planes>
    \sa
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link tv_working_with_base_classes_reference_geometry, Working with Reference Geometry>
  */
