...
public:
  ...
  /** \details
    Default constructor for objects of the OdGeCubicSplineCurve3d class.
  */
  OdGeCubicSplineCurve3d();

  /** \details
    Constructor for objects of the OdGeCubicSplineCurve3d class. Creates a clone
  ...
  */
  ...
  /** \details
    ...
    periodic (closed) cubic spline curve. The last fit point must equal the
    first one.
  ...
  */
  ...
  /** \details
    Constructor for objects of the OdGeCubicSplineCurve3d class. Constructs a
    cubic spline curve based on a reference curve.
  ...
  */
  ...
  /** \details
    ...
    at the fit points. It can create periodic (closed) and non-periodic (open)
    cubic spline curves.
  ...
  */
  ...
  /** \details
    This is the assignment operator for objects of the OdGeCubicSplineCurve3d
    class. Assigns the value of the second operand to the first one.

    \param spline [in] OdGeCubicSplineCurve3d object to be assigned.

    \returns A reference to this OdGeCubicSplineCurve3d object.
  */
