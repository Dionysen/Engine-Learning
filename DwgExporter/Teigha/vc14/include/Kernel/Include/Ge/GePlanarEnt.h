...
public:
  /** \details
    Returns true if and only if the specified point is on this plane,
    regardless of the envelope, as determined by the tolerance.
  ...
  */
  ...
  /** \details
    ...
    \param line [in]  A 3D linear entity with which the intersection is computed.
  ...
  */
  ...
  /** \details
    ...
    \param line [in]  A 3D linear entity for which the closest point is computed.
  ...
  */
  ...
  /** \details
    ...
    \param plane [in]  Any planar entity to which the closest point is computed.
  ...
  */
  ...
  /** \details
    ...
    \param line [in]  Any 3D linear entity that is tested to be parallel to this planar entity.
    \param tol [in]  Geometric tolerance.
  */
   bool isParallelTo(
    const OdGeLinearEnt3d& line, 
  ...
  /** \details
    ...
    \param plane [in]  Any planar entity that is tested to be parallel to this planar entity.
    \param tol [in]  Geometric tolerance.
  */
   bool isParallelTo(
    const OdGePlanarEnt& plane,
  ...
  /** \details
    ...
    \param line [in]  Any 3D linear entity that is tested to be perpendicular to this planar entity.
    \param tol [in]  Geometric tolerance.
  */
  ...
  /** \details
    ...
    \param plane [in]  Any planar entity that is tested to be perpendicular to this planar entity.
    \param tol [in]  Geometric tolerance.
  */
  bool isPerpendicularTo(
    const OdGePlanarEnt& plane,
  ...
  /** \details
    ...
    the specified plane is coplanar with this one.

    \param plane [in]  Any plane that is tested to be coplanar to this planar entity.
    \param tol [in]  Geometric tolerance.
  */
   bool isCoplanarTo(
    const OdGePlanarEnt& plane,
  ...
  */
  ...
  /** \details
    ...
    \param p [in]  A 3D point through which a vector passes.
    \param unitDir [in]  Unit vector specifying the projection direction.
    \param projP [out]  Receives the point on the plane in place where the specified vector intersects the plane.
    \param tol [in]  Geometric tolerance.
  */
