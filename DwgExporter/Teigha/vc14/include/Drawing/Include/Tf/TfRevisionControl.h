...
namespace OdTfRevisionControl
{
  ...
  */
  TFDLL_EXPORT void beginPartialImport(OdStreamBuf* pStream, OdDbDatabase* pDb);
...
protected:
  ...
  protected:
    ...
    friend void OdTfRevisionControl::beginPartialImport(OdStreamBuf* pStream, OdDbDatabase* pDb);
...
public:
  /** \details
    ...
    \returns Pointer to the repository object corresponding to the storage.
  */
  static OdTfRepositoryPtr createObject(OdStreamBuf* pStream, OdDbHostAppServices* pHostApp);

  /** \details
    Initializes a storage after creation by
    OdTfRepository::createObject(OdStreamBuf*, OdDbHostAppServices*).
  ...
  */
  ...
  /** \details
    Same as OdTfStorage::makePatch() but for commits instead of revisions and
