...
public:
  ...
  */
  ...
  virtual OdResult isRelevantDependencyChangeOverride(const OdDbAssocDependency* pDependency, bool& isRelevantDepChange) const override;
...
///** { Secret } */ // TODO
void DBCONSTRAINTS_EXPORT odrxAssocArrayAdjustLocation(OdDbObjectId arrayId, const OdDbAssocArrayParametersPtr& pParameters);
...
///** { Secret } */
OdUInt32 DBCONSTRAINTS_EXPORT OdDbAssocArrayActionBody_setSkipNextFlags(OdUInt32 flags); // for tests only
