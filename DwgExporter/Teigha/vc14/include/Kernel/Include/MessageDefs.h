...
// AssocNetwork
OD_MESSAGE_DEF( sidActionStatus,            OD_T("action status"))
OD_MESSAGE_DEF( sidEvaluationQueue,         OD_T("evaluation queue"))
OD_MESSAGE_DEF( sidkChangedDirectly,        OD_T("'Changed Directly'"))
OD_MESSAGE_DEF( sidkParameterArray,         OD_T("parameter array"))
OD_MESSAGE_DEF( sidkZeroIdsFound,           OD_T("null object id(s) found"))
