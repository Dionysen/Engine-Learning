...
#ifndef _BM_MASONRYAPPEARANCESCHEMA_RELIEF_H_
#define _BM_MASONRYAPPEARANCESCHEMA_RELIEF_H_
#include "Geometry/Entities/BmAsset.h"

/** \details
  A helper class to work with relief part of Masonry appearance schema.
*/
class TB_GEOMETRY_EXPORT OdBmMasonryAppearanceSchemaRelief
{
public:
  /** \details
    Default constructor.
  ...
  */
  OdBmMasonryAppearanceSchemaRelief(const OdBmAssetPtr& pAsset) :m_pAsset(pAsset) {}
...
#endif // _BM_MASONRYAPPEARANCESCHEMA_RELIEF_H_
