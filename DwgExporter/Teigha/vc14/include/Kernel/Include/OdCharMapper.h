...
//	static OdResult initialize(OdStreamBuf* pIo);
  ...
  */
   ...
   */
   ...
   /** \details
     Returns converted unicode string from CIF coding string
     \param str [in]  Source string for conversion.
   */
   static OdString convertCIFcoding(const OdString& strText);

   /** \details
     Returns converted unicode string from Latin alpha numeric Japanese unicode range
     \param str [in]  Source string for conversion.
   */
   static OdString convertAlphaNumJapanese(const OdString& strText);

   /** \details
     Returns converted ANSI string from Latin alpha numeric Japanese code page
     \param str [in]  Source string for conversion.
   */
