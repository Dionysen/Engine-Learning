...
class OdGsBaseVectorizeViewJoin : public OdGsBaseVectorizeView, public BaseVectorizerObject
{
  public:
    /** \details
      Default constructor for the OdGsBaseVectorizeViewJoin class.
    */
    ...
    */
    ...
    /** \details
      Checks whether joined view has perspective projection.
    */
    ...
    /** \details
      Retrieves object to device transformation matrix.
    */
    ...
    /** \details
      Retrieves the display pixel density at the specified point for the Viewport object. Does nothing in current implementation.
    ...
    */
    ...
    /** \details
      Retrieves object to device transformation matrix.
      \remarks
      Typically you should call it from vectorizer, elsewhere it should not differ from worldToDevice.
    */
    OdGeMatrix3d objectToDeviceMatrix() const
    {
      return OdGiBaseVectorizerImpl::objectToDeviceMatrix();
    ...
    /** \details
      Converts the passed lineweight definition width to a number of pixels.
      \param lineweight [in]  Lineweight definition to convert.
    */
    ...
    /** \details
      Converts the passed lineweight width to a number of pixels.
      \param lineweight [in]  Lineweight to convert.
    */
    ...
    */
    ...
    /** \details
      Checks whether the plot styles are supported.
      \returns
...
class OdGsBaseVectorizeViewJoinMT : public OdGsBaseVectorizeViewJoin<BaseVectorizerObject>
{
  ...
  public:
    ...
    /** \details
      Default constructor for the OdGsBaseVectorizeViewJoinMT class.
    */
    ...
    */
    ...
    /** \details
      Retrieves a vectorizer that is used in a vectorization process.
    ...
    */
    ...
    /** \details
      Checks whether multithreading is used for regeneration process.
      \returns
      true if multithreading is used for regeneration process, false otherwise.
    */
...
class OdGsBaseVectorizeViewDef : public OdGsBaseVectorizeViewJoin<OdGsBaseVectorizer>
{
  public:
    /** \details
      Default constructor for the OdGsBaseVectorizeViewDef class. 
    */
...
class OdGsBaseVectorizeViewMT : public OdGsBaseVectorizeViewJoinMT<OdGsBaseVectorizer>
{
  public:
    /** \details
      Default constructor for the OdGsBaseVectorizeViewMT class. 
    */
