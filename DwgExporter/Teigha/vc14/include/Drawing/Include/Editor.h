...
public:
  ...
  */
  ...
  virtual void xrefSubCommandStart(OdDbDatabase* pHostDb, OdXrefSubCommand subCmd, const OdDbObjectIdArray& btrIds,
    const OdStringArray& btrNames, const OdStringArray& paths);

  virtual void xrefSubCommandStart(OdDbDatabase* pHostDb, OdXrefSubCommand subCmd, const OdDbObjectIdArray& btrIds,
    const OdStringArray& btrNames, const OdStringArray& paths, bool& veto) ODRX_OVERRIDE; 
};
