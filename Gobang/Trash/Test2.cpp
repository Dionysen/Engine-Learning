...
void Test2::OnAttach()
{
    m_CheckerboardTexture = Dionysen::Texture2D::Create("assets/textures/Checkerboard.png");
}
...
void Test2::OnUpdate(Dionysen::Timestep ts)
{
    // Update
...
void Test2::OnEvent(Dionysen::Event& e)
{
