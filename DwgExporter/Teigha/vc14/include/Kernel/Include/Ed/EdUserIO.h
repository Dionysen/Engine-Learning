...
namespace OdEd
{
  enum CommonInputOptions
  {
    ...
    kInpThrowEmptyInQuotes = 0x02000000
  };
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param pErrCtx [in] Pointer to the OdErrorContext class.
  */
...
public:
  ...
  /** \details
    Constructor for the OdEdKeyword class.
    
    \param nKeyword [in] Index of a keyword.
    \param sKeyword [in] Keyword text.
  */
...
public:
  ...
  /** \details
    ...
    \param sInput [in] Text string for this input object.
  */
...
public:
  ...
  /** \details
    Destructor for the OdEdEmptyInput class.
  */
  OdEdEmptyInput();
};
