...
public:
  ...
  /** \details
    ...
    \returns 
    true if object is drawn successfully or false if implementation is missing or in error case.
  */
...
/** \details
    ...
    \param pGeom [in] Client geometry object into which final mapped image will be drawn.
    \param pImage [in] Input raster image object.
    \param pBoundary [in] Set of 4 points which represents output raster image boundary in WCS.
    \param bFilter [in] Enables smooth interpolation filter during image scaling.
    \param brightness [in] Image brightness [0 .. 100].
    \param contrast [in] Image contrast [0 .. 100].
    \param fade [in] Image fade value [0 .. 100].
    ...
    4. Bottom-right.
*/
ODGI_EXPORT void odgiImageViewport(OdGiViewportGeometry &pGeom, const OdGiRasterImage *pImage, const OdGePoint3d *pBoundary,
                                   bool bFilter = true, double brightness = 50.0, double contrast = 50.0, double fade = 0.0);
