...
public:
  /** \details
    Default constructor for the OdGsWriter class. Sets the following data members:
    <table>
...
public:
  /** \details
    Default constructor for the OdGsBaseVectorizer class.
  */
  OdGsBaseVectorizer();
...
public:  
  ...
  */
  ...
  /** \details
    Destructor for the OdGsBaseVectorizer class. Deletes the recorded history and timing, if exists.
  */
  ~OdGsBaseVectorizer();
  ...
  */
  ...
  /** \details
    Pushes a transformation matrix for a metafile onto the stack. The resulting transformation will be created by multiplying the specified transform matrix by the existing one.
    This allows you to easily adjust an entity coordinate system. Use the popMetafileTransform() to remove this transform matrix from the stack when you are finished with this transformation.

    \param xfm [in]  Transformation matrix.
    \param flags [in]  Metafile transform flags.
    \remarks
    This method takes effect only if the passed flags parameter has kSharedRefUpdate flag set to true.
  */
  ...
  */
  virtual OdGeMatrix3d metafileTransform() const;
  ...
  */
  ...
  /** \details
    ...
    \returns
    Returns true if geometry should be hidden, false otherwise.
  */
  ...
  */
  ...
  /** \details
    Begins view vectorization procedure.
  */
  virtual void beginViewVectorization();
  
  /** \details
    Ends view vectorization procedure.
  */
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link tv_working_with_features_highlighting, Working with Highlighting>
  */
  void highlight(bool bHighlight);
  /** \details
    Returns current highlighting data.
    \returns
    Returns pointer to the current highlighting branch
  */
  const OdGsStateBranch* currentHighlightBranch() const;
  /** \details
    Returns current visibility branch.
    \returns
    Returns pointer to the current visibility branch.
  */
  const OdGsStateBranch* currentVisibilityBranch() const;
  /** \details
  Finds subnode visibility branch.
  \returns
  Returns pointer to the subnode visibility branch.
  */
  OdGsStateBranch* findHiddenSubnodeBranch();

  /** \details
    Retrieves pointer to a currently active layer node.
  ...
  */
  ...
  /** \details
    Retrieves active render type.
  */
  OdGsModel::RenderType activeRenderType() const;
  
  /** \details
    Retrieves active buffer overlay.
  */
  OdGsOverlayId activeOverlay() const;

  /** \details
    Checks whether spatial index is disabled.
    \returns
    false if spatial index should be used when displaying, 
    otherwise all metafiles will be forced even if they are outside of view frustum.
  */
...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns
    true if the Render abort is set, false otherwise.
  */
...
protected:
  enum BaseVectorizerFlags
  {
    ...
    kAbsoluteDeviation      = OdGiBaseVectorizerImpl::kLastImplFlag << 4,
...
inline OdGeMatrix3d OdGsBaseVectorizer::metafileTransform() const
