...
VAR_DEF(   ODTDIST,                FILLETRAD,    (0.),                          (0.),                           (),                         ValidateEqGr(0.))
...
/**
  <title PDFUNDERLAYSHADEDMODE>
  <toctitle PDFUNDERLAYSHADEDMODE>
  ...
  <table>
    <b>Value</b>   <b>Description</b>
    false          Pdf underlays rendered in wireframe mode only
    true           Pdf underlays rendered in every mode
  </table>
  ...
  <group TD_SysVars_S>
*/
//<dom_var_def>bool PDFUNDERLAYSHADEDMODE;
VAR_DEF(ODTBOOL,                      PDFUNDERLAYSHADEDMODE,                  (false),                    (false),             (),               ValidateBOOL())
...
/**
  ...
  \remakrs Currently supported only in SpaModeler.
...
VAR_DEF(  double,                    LATITUDE,            (37.7950),               (37.7950),                             (),                         ValidateRange(-90., 90.))
...
VAR_DEF(  double,                    LONGITUDE,           (-122.3940),             (-122.3940),                             (),                         ValidateRange(-180., 180.))
...
DICR27VAR( double,               MLEADERSCALE,          (1.0),               (1.0),                        (),                         ValidateMLeaderScale())
...
/**
  ...
  <b>Note: </b>If is equal to "." then CLAYER is used for new center marks and centerlines entities.
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp; 
   OdDbDatabase::getCENTERLAYER()
   OdDbDatabase::setCENTERLAYER()
  </table>

<group TD_SysVars_C>
  */
//<dom_var_def>OdString CENTERLAYER;
...
/**
  <title HPMAXCONTOURPOINTS>
  <toctitle HPMAXCONTOURPOINTS>

  <table>
   <b>Type</b>            OdUInt32
   <b>Initial value</b>   100000
   <b>Read-Only</b>       No
   <b>Saved In</b>        Registry
   <b>Versions</b>        21.1+
  </table>

  HPMAXCONTOURPOINTS sets the maximum number of points on the contour (outline) that a hatch entity can contain and still be rendered. 
  Hatches do not render if the number of points exceeds the specified value. This can reduce the render time while zooming in on hatches with a large number of contour points.
  The default value of this variable is 100,000. Setting HPMAXCOUNTERPOINTS to 0 disables the check.
...
<group TD_SysVars_H>
  */
  //<dom_var_def>OdUInt32 HPMAXCONTOURPOINTS;
  REGVAR_DEF(OdUInt32, HPMAXCONTOURPOINTS, (100000), (), ValidateNone())

  /**
  <title HPCUTPOINTSLIMIT>
  <toctitle HPCUTPOINTSLIMIT>

  <table>
   <b>Type</b>            OdUInt32
   <b>Initial value</b>   7500
   <b>Read-Only</b>       No
   <b>Saved In</b>        Registry
   <b>Versions</b>        21.1+
  </table>

  HPCUTPOINTSLIMIT sets the maximum number of points to be used during rendering for the contour (outline) of a hatch entity. 
  Hatch rendering is simplified by reducing the number of points on the contour if the number of points exceeds the HPCUTPOINTSLIMIT value. As a result, the hatch appears jagged. 
  This setting reduces the render time of a hatch entity that contains a lot of points that are close enough to each other. 
  If the number of points exceeds the limit, but all of them are far apart, the hatch is not simplified.
  The default value of this variable is 7500. Setting HPCUTPOINTSLIMIT to 0 disables this check.
...
<group TD_SysVars_H>
  */
  //<dom_var_def>OdUInt32 HPCUTPOINTSLIMIT;
  REGVAR_DEF(OdUInt32, HPCUTPOINTSLIMIT, (7500), (), ValidateNone())

  /**
<title HPSMOOTHEVALUATE>
<toctitle HPSMOOTHEVALUATE>
...
HPSMOOTHEVALUATE controls whether a hatch is smoothed when a rendering device does not provide non-zero deviation. The default value is false.
The hatch entity must be added to the database before setting the HPSMOOTHEVALUATE variable. If the rendering device provides non-zero deviation values, 
enabling the HPSMOOTHEVALUATE variable can decrease rendering accuracy. 
Enabling the HPSMOOTHEVALUATE variable may require additional recalculations that can increase the total render time. 
...
<group TD_SysVars_H>
  */
  //<dom_var_def>bool HPSMOOTHEVALUATE;
  REGVAR_DEF(bool, HPSMOOTHEVALUATE, (false), (), ValidateNone())


/**
  <title SILHGENMODE>
  <toctitle SILHGENMODE>
  ...
  SILHGENMODE controls the default variant of silh generation,
  0 (default) - use old variant of silh generator
  1 - use new silh generator
  ...
  <table>
    ...
    OdDbDatabase::setSysVar()
    & nbsp;
    OdDbHostAppServices::getSILHGENMODE()
    OdDbHostAppServices::setSILHGENMODE()
  </table>

<group TD_SysVars_S>
  */
  //<dom_var_def>OdInt8 SILHGENMODE;
  REGVAR_DEF(OdInt16, SILHGENMODE, (0), (), ValidateRange(0, 1))
...
/**
    ...
    OdDbDatabase::setSysVar()
    & nbsp;
    OdDbHostAppServices::getSILHWIDTH()
    OdDbHostAppServices::setSILHWIDTH()
    </table>

    <group TD_SysVars_F>
    */
    //<dom_var_def>OdInt16 SILHWIDTH;
    //<dom_var_def>OdInt8 SILHWIDTH;
    REGVAR_DEF(OdInt16, SILHWIDTH, (-4), (), ValidateRange(-4, 211))
...
/**
  ...
  <table>
   ...
   2                    If set, demand-loads the source application when you call one of the application's commands. (Not supported by the Drawings but can be implemented in client applications).
   </table>
...
/**
  ...
  LAYLOCKFADECTL specifies the level of fading for entities on locked layers.
  Fading helps to visually detect if the layer is locked or not.
  Entities on locked layers remain visible and available for snapping.

  <table>
   <b>Value</b>   <b>Description</b>
   0              Locked layers are not faded.
   1 ... 90       Positive value determines the level of fading as a percent (up to 90%).
   -1 ... -90     Negative value does not fade locked layers, but is used to save the previous value and restore it by changing the sign.
  </table>

  <b>Note: </b>The value of fading is limited to 90% to avoid confusion with layers that are turned off or frozen.
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getLAYLOCKFADECTL()
   OdDbHostAppServices::setLAYLOCKFADECTL()
  </table>
...
/**
  ...
  <table>
   <b>Value</b>   <b>Description</b>
   0              No fading applied to .dwg external references.
   1 ... 90       Positive value determines the level of .dwg xref fading as a percent (up to 90%).
   -1 ... -90     Negative value does not apply fading to .dwg xrefs, but is used to save the previous value and restore it by changing the sign.
  </table>

  <b>Note: </b>The value of fading is limited to 90% to avoid making .dwg xrefs completely invisible.
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getXDWGFADECTL()
   OdDbHostAppServices::setXDWGFADECTL()
  </table>
...
REGVAR_DEF(OdInt16,   TEXTALIGNMODE,          (9),                  (),        ValidateRange(0,11))
...
///////////////////////////////////////////
// Drawings SDK-specific system variables
///////////////////////////////////////////
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getAcisProxyMode()
   OdDbHostAppServices::setAcisProxyMode()
  </table>

  <group TD_SysVars_A>
*/
//<dom_var_def>OdInt8 AcisProxyMode;
...
objects when ACIS data are read or written. This variable affects to Audit.
If EnableAcisAudit is set to true, additional checks of ACIS objects will be
done and in case of some of them failed - ACIS object may be discarded.

<table>
<b>Value</b>   <b>Description</b>
true           Use additional checks of ACIS data to prevent errors while a saved dwg/dxf is loaded by AutoCad2018.
false          Audit of ACIS data will not be performed, ACIS data will be loaded and saved without additional checks so AutiCad2018 may report an error or show the recovery dialog
</table>
...
The TableIndicator variable controls the display of row numbers and column letters
when the In-Place Text Editor is open for editing a table cell.
...
OdDbDatabase::setSysVar()
&nbsp; 
OdDbHostAppServices::getTableIndicator()
OdDbHostAppServices::setTableIndicator()
</table>

For example, to get the value:
<code>
OdResBufPtr pRb = pDb-\>getSysVar(L"TableIndicator");
bool bEnabled = pRb-\>getBool();
odPrintConsoleString(L"nTableIndicator is %s", ((bDisabled) ? "ON" : "OFF"));
// or //
bool bEnabled = pDb-\>appServices()-\>getTableIndicator();
odPrintConsoleString(L"nTableIndicator = %s", ((bEnabled) ? "ON" : "OFF"));
</code>
For example, to set the value:
<code>
OdResBufPtr pRb = OdResBuf::newRb(OdResBuf::kRtBool, true);
pDb-\>setSysVar(L"TableIndicator", pRb);
// or //
...
*/
/**
<title TableLinkIndicator>
<toctitle TableLinkIndicator>
...
OdDbDatabase::setSysVar()
&nbsp; 
OdDbHostAppServices::getTableLinkIndicator()
OdDbHostAppServices::setTableLinkIndicator()
</table>

For example, to get the value:
<code>
OdResBufPtr pRb = pDb-\>getSysVar(L"TableLinkIndicator");
bool bEnabled = pRb-\>getBool();
odPrintConsoleString(L"nTableLinkIndicator is %s", ((bDisabled) ? "ON" : "OFF"));
// or //
bool bEnabled = pDb-\>appServices()-\>getTableLinkIndicator();
odPrintConsoleString(L"nTableLinkIndicator = %s", ((bEnabled) ? "ON" : "OFF"));
</code>
For example, to set the value:
<code>
OdResBufPtr pRb = OdResBuf::newRb(OdResBuf::kRtBool, true);
pDb-\>setSysVar(L"TableLinkIndicator", pRb);
// or //
...
*/
/**
<title TableSelectIndicator>
<toctitle TableSelectIndicator>
...
OdDbDatabase::setSysVar()
&nbsp; 
OdDbHostAppServices::getTableSelectIndicator()
OdDbHostAppServices::setTableSelectIndicator()
</table>

For example, to get the value:
<code>
OdResBufPtr pRb = pDb-\>getSysVar(L"TableSelectIndicator");
bool bEnabled = pRb-\>getBool();
odPrintConsoleString(L"nTableSelectIndicator is %s", ((bDisabled) ? "ON" : "OFF"));
// or //
bool bEnabled = pDb-\>appServices()-\>getTableSelectIndicator();
odPrintConsoleString(L"nTableSelectIndicator = %s", ((bEnabled) ? "ON" : "OFF"));
</code>
For example, to set the value:
<code>
OdResBufPtr pRb = OdResBuf::newRb(OdResBuf::kRtBool, true);
pDb-\>setSysVar(L"TableSelectIndicator", pRb);
// or //
...
*/
REGVAR_DEF(OdUInt32,            TableIndicatorColor,          0xC2ADADAD,                0xC2ADADAD,      ValidateNone())
...
*/
REGVAR_DEF(bool,                 PartialViewingMode,           (false),                         (),        ValidateBOOL())
