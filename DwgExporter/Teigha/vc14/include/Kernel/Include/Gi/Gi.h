...
public:
  ...
  */
  enum DrawFlags
  {
    ...
    kRegenTypeDependent2dDraw   = 0x40000000,
    kAuxModelerGeom             = 0x80000000,
    kInternalDrawFlags = kDisableLayoutCache | kClipSetIsEmpty | kAuxModelerGeom | kRegenTypeDependent2dDraw,
