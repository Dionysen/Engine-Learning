...
/** \details
  A data type that represents a smart pointer to an <link OdGiXformOptimizer, OdGiXformOptimizer> object.
*/
...
/** \details
  A data type that represents a smart pointer to an <link OdGiTranslationXform, OdGiTranslationXform> object.
*/
