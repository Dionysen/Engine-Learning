...
public:
  ...
  /** \details
    Default constructor for the OdGeCurveCurveInt2d class. Constructs an invalid curve-curve intersector with no intersection curves and default tolerance.
  */
  OdGeCurveCurveInt2d();
  /** \details
  ...
  */
  ...
  /** \details
    Calculates the configuration of the intersecion point of
