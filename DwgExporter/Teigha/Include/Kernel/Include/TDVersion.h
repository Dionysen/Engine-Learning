...
#define TD_SHORT_STRING_VER_S   "19.7"
#define TD_SHORT_STRING_VER_W  L"19.7"

#define TD_PRODUCT_VER_STR_S   "19.7.0.0"
#define TD_PRODUCT_VER_STR_W  L"19.7.0.0"

//Changed in VersionInfo to TD_PRODUCT_NAME_S " " TD_PRODUCT_VER_STR_S
//That need for NET and ActiveX
#define TD_BUILD_COMMENTS_S    "Teigha\xAE 19.7.0.0"
#define TD_BUILD_COMMENTS_W   L"Teigha\x00AE 19.7.0.0"
...
#if _MSC_VER == 1200
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_6"
#elif _MSC_VER == 1310
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_7"
#elif _MSC_VER == 1400
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_8"
#elif _MSC_VER == 1500
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_9"
#elif _MSC_VER == 1600
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_10"
#elif _MSC_VER == 1700
...
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_b6"
#elif __BORLANDC__ >= 0x0610 && __BORLANDC__ <= 0x0619
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_b9"
#elif __BORLANDC__ >= 0x0620 && __BORLANDC__ <= 0x0629
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"src_b10"
#else
#error "Unsupported compiler for suffixed version"
#endif
#endif
