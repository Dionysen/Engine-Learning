...
/** \details
    This class implements pointer to a Mutex in an ODA Platform context,
...
public:
  /** \details
      Returns true if ThreadsCounter has registered threads and the ODA Platform works in multithreading mode.
  */
  ...
  */
  ...
  /* Following methods are intended for internal usage by ODA Platform libraries and not recommended for usage outside. */
