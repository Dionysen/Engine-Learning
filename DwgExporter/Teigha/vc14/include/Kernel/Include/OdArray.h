...
public:
  ...
  */
  static inline void constructn(
    ...
    const T& value)
  {
    OdMemoryAllocator<T>::constructn(pDestination, numElements, value);
  }
  ...
  */
  static inline void constructn(
    ...
    size_type numElements)
  {
    OdMemoryAllocator<T>::constructn(pDestination, pSource, numElements);
  }
  ...
  \remarks
  When called with two arguments, this function clears memory.
  */
  static inline void constructn(
    T* pDestination,
    size_type numElements)
...
public:
  ...
  */
  ...
  /** \details
    Returns a reverse iterator that references the last element in this Array object.
  */
  ...
  /** \details
    Returns a reverse const_iterator that references the last element in this Array object.
  */
  ...
  */
  ...
  { 
    ...
    if (!referenced())
    {
      if (len == physicalLength())
      {
        const T valueCopy(value);
        copy_buffer(newLen, true);
        A::construct(m_pData + len, valueCopy);
      }
      else
      {
        A::construct(m_pData + len, value);
      }
    }
    else
    {
  ...
  */
    ...
    const T& value)
  {
    ...
    A::constructn(m_pData + len, numElements);
  ...
  */
  ...
  /** \details
    Returns an iterator (pointer) to the first element after the last element in the array.
  */
  iterator append() 
  { 
