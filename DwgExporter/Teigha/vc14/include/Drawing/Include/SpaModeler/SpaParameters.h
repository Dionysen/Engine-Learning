...
public:
  ...
  bool bUseFacetRES;
  int check_level;// check level used in api_check_entity
  double mass_props_req_rel_accy;// required relative accuracy for mass properties calculations
