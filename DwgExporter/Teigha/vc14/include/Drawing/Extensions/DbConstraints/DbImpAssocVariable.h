...
public:     
  ...
  */
  OdResult fixVariable(const OdString& name, const OdDbEvalVariant* value);
  ...
  */
  ...
  /** \details
    Creating a shallow copy of the variable which is not connected to anything but
    has same name, expression, etc.
  */
  static OdDbAssocVariablePtr createVariableCopy(const OdDbAssocVariable* originalVar);
  ...
  */
  OdResult setValue(OdDbAssocAction* pAction, const OdDbEvalVariant& newValue);
  ...
  */
  ...
  /** \details
    For internal use.
  */
  void setIsMergeable(bool isMerg, bool mustMerg = false, const OdString& mergeableVariableName = OdString::kEmpty);
  ...
  */
  OdResult dwgInFields(OdDbAssocAction *self, OdDbDwgFiler* filer);
