...
public:
  ...
  */
  OdDbAssocArrayPolarParameters(double angle = 15.0, // by ACAD // = OdaToRadian(60)
                                double rowSpacing = 1.0, // by ACAD // = 200
                                double levelSpacing = 1.0, // by ACAD // = 200,
                                int itemCount = 1, // by ACAD // = 6,
                                int rowCount = 1, 
                                int levelCount = 1,
                                double rowElevation = 1.0); // by ACAD // = 0
  ...
  */
  ...
  /** \details
    ...
    The input value will be rounded off to (0-360] degree. This must be a positive value.
  */
