...
class OdRxMemberCollection;
class OdRxAttributeCollection;
class OdRxMemberCollectionBuilder;
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link rtti_class_describing.html, Implementing the Class Describing Structure>
  */
  OdDb::DwgVersion getClassVersion(
...
inline bool OdRxObject::isKindOf(const OdRxClass* pClass) const {
