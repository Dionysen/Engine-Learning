...
public:
  ...
  /** \details
    Implements the corresponding 'Override' method of the OdDbAssocActionBody
  ...
  */
  virtual OdResult addMoreObjectsToDeepCloneOverride(const OdDbAssocActionBody *body,
    OdDbIdMapping &idMap, OdDbObjectIdArray &additionalObjectsToClone) const ODRX_OVERRIDE;
