...
public:
  ...
  */
  ...
  \returns Returns true if content should be selected without playing; otherwise returns false
  */
...
/** \details
  A data type that represents a smart pointer to an <link OdGiSelectProc, OdGiSelectProc> object.
*/
