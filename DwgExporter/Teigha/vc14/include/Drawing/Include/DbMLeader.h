...
///** { Secret } */
bool DBDIM_EXPORT OdDbMLeader_setAcadBehaviour(OdDbMLeader* pMLeader, OdUInt32 bug, bool bValue); // for tests only

///** { Secret } */
OdGePoint3d DBENT_EXPORT OdDbMLeader_getPtInternal(OdDbMLeader* pMLeader, OdUInt32 index = 0); // for tests only

///** { Secret } */
void DBENT_EXPORT OdDbObject_clearDatabase(OdDbObject* pObj); // for tests only

///** { Secret } */
//void DBENT_EXPORT OdDbObject_clearModified(OdDbObject* pObj); // for tests only
