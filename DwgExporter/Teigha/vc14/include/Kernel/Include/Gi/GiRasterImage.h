...
/** \details
    This class represents a raster image within the ODA Platform vectorization framework.
    Corresponding C++ library: TD_Gi
    
    <group OdGi_Classes> 
    \sa
    <link gi_raster_images, Working with Raster Images>
*/
...
public:
  ...
  */
  ...
  /** \details
  Returns number of millimeters in given unit.
  */
  ...
  /** 
  Represents sources for raster images.
  */
  enum ImageSource
  {
  ...
  */
  typedef struct tagPixelFormatInfo
  {
    ...
    /** \details
      Checks whether the passed pixel format data is equal to this pixel format data.
      
      \param other [in]  Pixel format data to compare.
      
      \returns
      true if pixel format data is equal to this pixel format data, false otherwise.
    */
    ...
    /** \details
      Constructor for the tagPixelFormatInfo struct. Initializes all data members to 0.
    */
    tagPixelFormatInfo()
      : redOffset(0)
      , numRedBits(0)
    ...
    /** \details
      ...
      \returns 
      true if the pixel format of this RasterImage object is RGB, false otherwise.
    */
    bool isRGB() const
    {
    ...
    */
    ...
    /** \details
      ...
      \returns 
      true if the pixel format of this RasterImage object is BGR, false otherwise.
    */
    bool isBGR() const
    {
      return bitsPerPixel == 24 && 
    ...
    */
    ...
    /** \details
      ...
      \returns 
      true if the pixel format of this RasterImage object is 16-bit BGR, false otherwise.
    */
    ...
    */
    ...
    /** \details
      ...
      \returns 
      true if the pixel format of this RasterImage object is RGBA, false otherwise.
    */
    bool isRGBA() const
    {
    ...
    */
    ...
    /** \details
      ...
      \returns
      true if the pixel format of this RasterImage object is BGRA, false otherwise.
    */
    bool isBGRA() const
    {
      return bitsPerPixel == 32 && alphaOffset == 24 && numAlphaBits == 8 &&
  ...
  /** \details
    ...
    \returns
    number of pixels as OdUInt32 value that represents width of this raster image.
  */
  ...
  /** \details
    ...
    \returns
    number of pixels as OdUInt32 value that represents height of this raster image.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns 
    Smart pointer to the image with new image source.
  */
  ...
  /** \details
    ...
    \returns 
    Smart pointer to the image with new image source file name.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns
    the size of a single scanline in BMP format as OdUInt32 value.
  */
  ...
  */
  ...
  /** \details
    Retrieves user-end implementation of raster image.
    \remarks
...
/** \details
  A data type that represents a smart pointer to an <link OdGiRasterImage, OdGiRasterImage> object.
*/
...
public:
  ...
  /** \details
    Represents parameter types for raster images.
  */
  enum ParamType
  {
...
/** \details
  A data type that represents a smart pointer to an <link OdGiRasterImageParam, OdGiRasterImageParam> object.
*/
