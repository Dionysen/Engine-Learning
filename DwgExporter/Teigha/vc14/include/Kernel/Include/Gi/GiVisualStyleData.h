...
class OdGiVisualStyleDataContainer : public OdStaticRxObject<OdGiVisualStyle>
{
  public:
    ...
    */
    ...
    {
      /** Variant data storage object with which this color wrapper is associated. */
      OdGiVariant *m_pVar;

      /** \details
        Default constructor for the OdCmColorBaseAdapt class.
      */
      ...
      */
      ...
      /** \details
        Checks whether the color method is byColor for the entity color object.
        \returns 
        true if the color method is set to _kByColor_, otherwise it returns false.
      */
      bool isByColor() const { return entColor().isByColor(); }
      
      /** \details
        Checks whether the color method is byLayer for the entity color object. 
        \returns
        true if the color method is set to _kByLayer_ or _kACIbyLayer_, otherwise it returns false.
      */
      bool isByLayer() const { return entColor().isByLayer(); }
      
      /** \details
        Checks whether the color method is byBlock for the entity color object. 
        \returns
        true if the color method is set to _kByBlock_ or _kACIbyBlock_, otherwise it returns false.
      */
      bool isByBlock() const { return entColor().isByBlock(); }
      
      /** \details
        Checks whether the color method is byACI for the entity color object.
        \returns 
        true if the color method is set to _kByACI_, otherwise it returns false.   
        \remarks
      ...
      */
      ...
      /** \details
        ...
        \returns 
        true if the color method is set to _kForeground_ or _kACIforeground_, otherwise it returns false.
      */
      ...
      /** \details
        ...
        \returns 
        true if the color method is set to _kByDgnIndex_, otherwise it returns false.
      */
    ...
    */
    class OdGiFaceStyleDataContainer : public OdStaticRxObject<OdGiFaceStyle>
    {
      ...
      public:
        /** \details
          Default constructor for the OdGiFaceStyleDataContainer class. Initializes the base object to NULL
        */
        ...
        /** \details
          Destructor for the OdGiEdgeStyleDataContainer class.
        */
        ~OdGiFaceStyleDataContainer()
        {
        }
    ...
    */
    class OdGiEdgeStyleDataContainer : public OdStaticRxObject<OdGiEdgeStyle>
    {
      ...
      public:
        /** \details
          Default constructor for the OdGiEdgeStyleDataContainer class. Initializes the base object to NULL
          and sets default edge apply mode.
        */
        ...
        */
        ...
        /** \details
          ...
          \param flag [in]  Flag to be checked whether it's enabled or disabled.
          \returns
          true if the passed edge style flag is set, false otherwise.
        */
    ...
    */
    class OdGiDisplayStyleDataContainer : public OdStaticRxObject<OdGiDisplayStyle>
    {
      ...
      public:
        /** \details
          Default constructor for the OdGiDisplayStyleDataContainer class. Initializes the base object to NULL.
        */
        ...
        /** \details
          Destructor for the OdGiDisplayStyleDataContainer class.
        */
        ~OdGiDisplayStyleDataContainer()
        {
        }
  ...
  public:
    /** \details
      Default constructor for the OdGiVisualStyleDataContainer class. Sets face, edge and display styles and 
      also sets values for face, edge and display properties.
    */
    OdGiVisualStyleDataContainer()
      : m_faceStyle()
      , m_edgeStyle()
