...
/** \details
  <group ExRender_Windows_Classes>
  Property definition for the highlight branch
*/
struct OdTrVisHlBranchPropertyDef : public OdTrVisIdPropertyDef
{
  OdTrVisHlBranchPropertyDef(OdTrVisStateBranchId branchId)
    : OdTrVisIdPropertyDef(kHlBranchProperty, (OdTrVisId)branchId) {}
  /** \details
...
/** \details
    <group ExRender_Windows_Classes> 
    Property definition for the visibility branch
*/
struct OdTrVisVsBranchPropertyDef : public OdTrVisIdPropertyDef
{
  OdTrVisVsBranchPropertyDef(OdTrVisStateBranchId branchId)
    : OdTrVisIdPropertyDef(kVsBranchProperty, (OdTrVisId)branchId) {}
  /** \details
  Retrives property value
  \returns Returns property value
  */
