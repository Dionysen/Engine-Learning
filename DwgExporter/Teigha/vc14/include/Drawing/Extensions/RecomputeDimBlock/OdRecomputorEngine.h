...
public:
  ...
  */
  virtual void calcTextExtents(OdDbMTextPtr& pMText, bool force = false, bool bApplyXText = true );
  ...
  */
  ...
  OdDbMTextPtr createXText(OdDbMTextPtr pText, OdInt16 dimtmove, bool bUserDefPos, double dTextRot, bool oneText = false);
