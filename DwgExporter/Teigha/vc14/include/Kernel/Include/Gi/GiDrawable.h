...
public:
  ...
  */
  enum SetAttributesFlags
  {
    ...
    kDrawableNotAllowLCS                  = 32768, // Currently not supported.
    kDrawableMergeControlOff              = 65536, // Merge Control disabled for this drawable

    kLastFlag                             = kDrawableMergeControlOff // Marker
  };
  ...
  */
  enum DrawableType
  {
      kGeometry              = 0,     // Geometry.
      kDistantLight          = 1,     // Distant light. This number is important!
      kPointLight            = 2,     // Point light. This number is important!
      kSpotLight             = 3,     // Spot light. This number is important!
      kAmbientLight,                  // Ambient light.
      kSolidBackground,               // Solid background light.
      kGradientBackground,            // Gradient background.
      kImageBackground,               // Image background.
      kGroundPlaneBackground,         // Ground plane background.
      kViewport,                      // Viewport.
      kWebLight,                      // Web light.
      kSkyBackground,                 // Sky background.
      kImageBasedLightingBackground   // Image-based lightning background.
  };
...
/** \details
  A data type that represents a smart pointer to an <link OdGiDrawable, OdGiDrawable> object.
*/
