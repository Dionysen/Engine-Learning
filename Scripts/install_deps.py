...
def install_deps():
    ...
    requirements_path = os.path.join(project_root, "scripts/requirements.txt")
...
# Install external =====================================================
urls = {
    "ODA": "https://gaid-data.obs.cn-north-4.myhuaweicloud.com/ide/dwg/ODA.zip",
    "spdlog": "https://gaid-data.obs.cn-north-4.myhuaweicloud.com/ide/dwg/spdlog.zip"
}
