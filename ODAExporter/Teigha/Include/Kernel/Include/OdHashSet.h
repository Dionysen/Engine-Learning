...
class OdHashSetLs : public OdUnorderedSet<Key, _HashFcn, 
#if !defined(__BORLANDC__)
od_std_hash_set_generalized_equal_to<Key, _HashFcn>, 
#endif
Alloc> {};
#elif defined(_MSC_VER)
// MSVC
...
class OdHashSet : public OdUnorderedSet<Key, HashFcn, 
#if !defined(__BORLANDC__)
std::equal_to<Key>, 
#endif
Alloc> {};
