...
public: 
  ...
  */
  ...
  virtual OdResult dependentObjectClonedOverride(OdDbAssocActionBody* thisBody,
    const OdDbAssocDependency* dependency, const OdDbObject* original, const OdDbObject* clone);
  ...
  */
  ...
  /** \details
    Base implementation of the corresponding 'Override' method of the OdDbAssocActionBody
    which owns this implementation object.

    \sa
    OdDbAssocActionBody::addMoreObjectsToDeepCloneOverride()
    OdDbAssocAction::addMoreObjectsToDeepClone()

    \returns eNotImplemented by default
  */
  virtual OdResult addMoreObjectsToDeepCloneOverride(const OdDbAssocActionBody* thisBody,
    OdDbIdMapping& idMap, OdDbObjectIdArray& additionalObjectsToClone) const { return eNotImplemented; }
...
protected:
  ...
  OdDbEntityPtr checkAccompanying(OdDbObjectId parentActionId, OdDbAssocAction* pAction);
  /** \details
  ...
  */
  ...
  OdDbObjectId entityInsert(OdDbObjectId parentActionId) const { return getArrayEntity(parentActionId); }
  ...
  friend class OdDbCenterMarkActionBody;
...
public: 
  ...
  */
  ...
  OdResult addMoreObjectsToDeepCloneOverride( const OdDbAssocActionBody *pBody,
                                              OdDbIdMapping& idMap, 
...
public:
  ...
  */
  ...
  virtual OdResult addMoreObjectsToDeepCloneOverride(const OdDbAssocActionBody* thisBody,
    OdDbIdMapping& idMap, OdDbObjectIdArray& additionalObjectsToClone) const;
