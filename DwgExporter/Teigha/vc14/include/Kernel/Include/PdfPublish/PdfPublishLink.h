...
public:
  ...
  */
  ...
  /** \details
    ...
    \param source_type  [in] A JavaScript scenario source code type.
    \sa
  ...
  */
  ...
  /** \details
    Returns the current JavaScript scenario for the link control.
    ...
    \param source_type  [out] A placeholder for the JavaScript source code type.
    \sa
    <link OdPdfPublish::Source::Type, Source::Type enumeration>.
  */
  ...
  /** \details
    Returns the current border width of the link control.
  ...
  */
  ...
  /** \details
    Returns the current link highlighting mode.
    The method fills a passed value with the current highlighting mode and returns it to a calling subroutine.
