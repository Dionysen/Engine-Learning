...
// ODA_MT_DB_END
  ...
  */
  enum UnitsValue
  {
    kUnitsUndefined    = 0,  //Undefined
    kUnitsInches       = 1,  //Inches
    kUnitsFeet         = 2,  //Feet
    kUnitsMiles        = 3,  //Miles
    kUnitsMillimeters  = 4,  //Millimeters
    kUnitsCentimeters  = 5,  //Centimeters
    kUnitsMeters       = 6,  //Meters
    kUnitsKilometers   = 7,  //Kilometers
    kUnitsMicroinches  = 8,  //Microinches
    kUnitsMils         = 9,  //Mils
    kUnitsYards        = 10, //Yards
    kUnitsAngstroms    = 11, //Angstroms
    kUnitsNanometers   = 12, //Nanometers
    kUnitsMicrons      = 13, //Microns
    kUnitsDecimeters   = 14, //Decimeters
    kUnitsDekameters   = 15, //Dekameters
    kUnitsHectometers  = 16, //Hectometers
    kUnitsGigameters   = 17, //Gigameters
    kUnitsAstronomical = 18, //Astronomical
    kUnitsLightYears   = 19, //Light years
    kUnitsParsecs      = 20, //Parsecs
    kUnitsUSSurveyFeet  = 21, //US Survey Feet
    kUnitsUSSurveyInch  = 22, //US Survey Inch
    kUnitsUSSurveyYard  = 23, //US Survey Yard
    kUnitsUSSurveyMile  = 24, //US Survey Mile
