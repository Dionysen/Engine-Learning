...
public: 
  ...
  */
  ...
  /** \details
    Deprecated.
  */
  OdResult getDependentOnCompoundObject(OdDbCompoundObjectIdPtr& compoundId) const {
    compoundId = OdDbCompoundObjectId::createObject();
  ...
  */
  void setDependentOnObject(const OdDbCompoundObjectId& compoundId);
  ...
  */
  ...
  /** \details
    ...
    to the given object.
  */
  static OdDbObjectId getFirstDependencyOnObject(const OdDbObject* pObject);

  /** \details
    Gets all dependency objects that are dependent on the given object.
  */
  static void getDependenciesOnObject(const OdDbObject* pObject, 
  ...
  */
  static OdResult notifyDependenciesOnObject(const OdDbObject* pObject, OdDbAssocStatus newStatus);
  ...
  */
  ...
  /** \details
    Notification callback for OdDbObject::copied(). This method is called when the dependent-on object is copied.
  ...
  */
  ...
  virtual OdDbObjectPtr subDeepClone(OdDbIdMapping& ownerIdMap, OdDbObject* owner, bool primary) const;
...
/** \details
  Use this class to disable change notifications to OdDbAssocDependencies.
  \remarks
  ...
  <group Contraint_Classes> 
*/
class TOOLKIT_EXPORT OdDbAssocDependencyNotificationDisabler {
public:
  /** \details
    Constructor.
  */
  explicit OdDbAssocDependencyNotificationDisabler(OdDbDatabase* db, bool disableIt = true);
  /** \details
    Destructor.
  */
  ~OdDbAssocDependencyNotificationDisabler();
  /** \details
