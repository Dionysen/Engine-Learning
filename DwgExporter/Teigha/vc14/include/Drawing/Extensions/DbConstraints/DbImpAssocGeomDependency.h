...
public: 
  ...
  */
  ...
  OdResult createNewEdgePersSubent(OdDbEntity* pEntity, OdDbAssocAction* pAction, OdUInt32& subentIndex);// , bool bNewPersSubentIndex);
