...
public:
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL void audit(OdDbAuditInfo* pAuditInfo) ODRX_OVERRIDE;
  ...
  */
  ...
  /** \details
    ...
    It transforms working plane by rigid motion component.
    If the transformation matrix also contains a uniform scaling factor,
    it removes all OdExplicitConstraint nodes.
    If the matrix contains a general component, it removes all OdGeomConstraint nodes.
  */
  ...
  */
  ...
  OdResult deleteConstrainedGeometry(const OdDbObjectIdArray& dependencyIds);
