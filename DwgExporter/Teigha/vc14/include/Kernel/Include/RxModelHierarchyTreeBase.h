  ...
  public:
    ...
    */
    ...
    /** \details
      ...
      \param create_properties_cache [in] Flag to create cache of properties. default value is true.
      \param class_dependent_hierarchy [in] Flag to optimize the creation of a hierarchical tree. 
      It can only be set to true if the properties of database objects with a hierarchical attribute are statically dependent on the object type. default value is false.
      \param class_dependent_property [in] Flag to optimize cache creation. It can be set to true only if all 
      properties of database objects are statically dependent on the object type. default value is false.
      \returns Returns a smart pointer to the root node of the hierarchical tree.
    */
    ...
    /** \details
      ...
      \param pDb [in] Pointer to the source database object.
      \param collected_properties [in] A pointer to a set of property names that will be added to the cache. If NULL, all properties will be cached.
      \param class_dependent_hierarchy [in] Flag to optimize the creation of a hierarchical tree.
      It can only be set to true if the properties of database objects with a hierarchical attribute are statically dependent on the object type. default value is false.
      \param class_dependent_property [in] Flag to optimize cache creation. It can be set to true only if all
      properties of database objects are statically dependent on the object type. default value is false.
    ...
    */
    ...
    /** \details
      ...
      \returns Returns a smart pointer to the root node of the tree.
    */
    ...
    /** \details
      ...
      \param unique_DB_ID [in] Unique Database identifier represented as OdUInt64.
      \param unique_source_ID [in] Unique identifier represented as OdUInt64.
    ...
    */
    ...
    /** \details
      ...
      \param pDb [in] Pointer to a filer object.
      \returns Returns the result of the deserialization operation.
    */
