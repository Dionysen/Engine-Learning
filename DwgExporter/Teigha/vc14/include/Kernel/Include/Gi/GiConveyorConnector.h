...
public:
  ...
  /** \details
    Default constructor for the OdGiConveyorConnector class.
  */
  OdGiConveyorConnector();
  /** \details
    Destructor for the OdGiConveyorConnector class.
  */
  virtual ~OdGiConveyorConnector() {}
  
  /** \details
    Adds source node to this connector.
    
    \param sourceNode [in]  Source node to be added.
  */
  void addSourceNode(OdGiConveyorOutput& sourceNode);
  
  /** \details
    Removes the specified source node from this connector.
    
    \param sourceNode [in]  Source node to be removed.
  */
  void removeSourceNode(OdGiConveyorOutput& sourceNode);
  
  /** \details
    Sets destination geometry.
  ...
  */
  ...
  /** \details
    Sets destination geometry for this conveyor connector.
    
    \param destGeometry [in]  Destination geometry.
  */
  OdGiConveyorGeometry& destGeometry() const;
  /** \details
    Retrieves a reference to the OdGiConveyorGeometry object associated with this object.
  */
