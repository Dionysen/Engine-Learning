...
struct OdGiDrawableDesc 
{
  /** \details
    ...
    pParent                 0             Pointer to the parent of the Drawable object.
    persistId               0             Persistent ID of the *database* object associated with the Drawable object.
    pTransientDrawable      0             Pointer to the Drawable object.
    nDrawableFlags          0             Drawable flags for the Drawable object (come from subSetAttributes).
    nDrawableDescFlags      0             Additional drawable flags.
    </table>
  */
  OdGiDrawableDesc()
    : pParent(0)
