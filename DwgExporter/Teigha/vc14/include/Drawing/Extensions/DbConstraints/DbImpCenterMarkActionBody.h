...
public:
  ...
  */
  ...
  OdDb::Visibility getExtensionLinesVisibility(OdDbAssocActionPtr pAction)const ;
	...
	static OdResult getRefCircle(OdGeCircArc3d & , const OdDbAssocGeomDependency* pGeomDep);
  ...
  OdResult setCenterPoint(const OdGePoint3d &, const OdDbObjectId &parentActionId);
