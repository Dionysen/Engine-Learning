...
namespace Dionysen
{
    ...
    void EditorLayer::OnAttach()
    {
        ...
        m_CheckerboardTexture = Texture2D::Create("Nut/assets/textures/Checkerboard.png");
        m_IconPlay            = Texture2D::Create("Nut/Resources/Icons/PlayButton.png");
        m_IconPause           = Texture2D::Create("Nut/Resources/Icons/PauseButton.png");
        m_IconSimulate        = Texture2D::Create("Nut/Resources/Icons/SimulateButton.png");
        m_IconStep            = Texture2D::Create("Nut/Resources/Icons/StepButton.png");
        m_IconStop            = Texture2D::Create("Nut/Resources/Icons/StopButton.png");
        ...
        else
        {
            ...
            // If no project is opened, close Dionysennut
    ...
    void EditorLayer::OnImGuiRender()
    {
        ...
        ImGui::Image((void*)(intptr_t)s_Font->GetAtlasTexture()->GetRendererID(), { 512, 512 }, { 0, 1 }, { 1, 0 });
    ...
    {
        std::string filepath = FileDialogs::OpenFile("Dionysen Project (*.hproj)\0*.hproj\0");
        if (filepath.empty())
            return false;
    ...
    {
        std::string filepath = FileDialogs::OpenFile("Dionysen Scene (*.Dionysen)\0*.Dionysen\0");
        if (!filepath.empty())
            OpenScene(filepath);
    }
    ...
    void EditorLayer::OpenScene(const std::filesystem::path& path)
    {
        ...
        if (path.extension().string() != ".Dionysen")
        {
    ...
    {
        std::string filepath = FileDialogs::SaveFile("Dionysen Scene (*.Dionysen)\0*.Dionysen\0");
        if (!filepath.empty())
        {
